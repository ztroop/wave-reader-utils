...
def _get_kwargs(
    *,
    ...
    segment_ended_after: Union[Unset, None, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/segments".format(client.base_url)
    ...
    params["segmentEndedAfter"] = segment_ended_after
...
def sync_detailed(
    *,
    ...
    """Get Measurement Segments belonging to the Account
    ...
    Args:
        ...
        segment_ended_after (Union[Unset, None, str]):
    ...
    kwargs = _get_kwargs(
        ...
        segment_ended_after=segment_ended_after,
    )
